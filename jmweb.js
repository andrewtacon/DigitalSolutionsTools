...
function getData(allData, textRows) {
    ...
    generate(title, subtitle, columns, textRows, min, max);


}


function generate(title, subtitle, columns, rows, min, max) {
    //  console.log(title)
    //  console.log(columns);
    let page = ``;
    //    page += `<h1>${title}</h1>`
   ...
   */
    ...
    //require('fs').writeFileSync('chart.html', complete);
